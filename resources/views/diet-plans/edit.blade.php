<x-layouts.app>
    ...
    <x-slot:topbarTitle>Edit Diet Plan</x-slot:topbarTitle>
    <x-slot:breadcrumb>Home / <a href="{{ route('diet-plans.index') }}">Diet Plans</a> / Edit</x-slot:breadcrumb>

    <div class="gh-card" style="max-width:600px;">
        <div class="gh-card-header"><h3 class="gh-card-title">Edit: {{ $dietPlan->name }}</h3></div>
            ...
            <form method="POST" action="{{ route('diet-plans.update', $dietPlan) }}">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                    <div style="grid-column:1/-1;">
                        ...
                        <input type="text" name="name" class="gh-input" value="{{ old('name', $dietPlan->name) }}" required>
                    </div>
                    <div>
                    ...
                    <div style="grid-column:1/-1;">
                        ...
                        <textarea name="description" class="gh-input" rows="3">{{ old('description', $dietPlan->description) }}</textarea>
                    </div>
                    <div>
