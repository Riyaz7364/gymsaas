<x-layouts.app>
    ...
    <div class="gh-card">
        <div class="gh-card-header">
            ...
            <a href="{{ gym_route('gym.workout-categories.create') }}" class="gh-btn gh-btn-primary">+ Add Category</a>
        </div>
        ...
        <div class="gh-card-body" style="padding:0;">
            <table class="gh-table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ gym_route('gym.workout-categories.edit', [$gym,$cat]) }}" class="gh-btn gh-btn-outline gh-btn-sm">Edit</a>
                        <form method="POST" action="{{ gym_route('gym.workout-categories.destroy', [$gym,$cat]) }}" style="display:inline;" onsubmit="return confirm('Delete?');">
                            @csrf @method('DELETE')
