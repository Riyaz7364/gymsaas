<x-layouts.app>
    ...
    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap:20px; margin-bottom:24px;">
        ...
        <div class="gh-stat-card">
            ...
            <div class="gh-stat-info">
                ...
                <span class="gh-stat-value">{{ auth()->user()->gym?->currency ?? '₹' }}{{ number_format($stats['monthly_revenue'] ?? 0) }}</span>
            </div>
                        ...
                        <tr>
                            <td>
                                <div style="display:flex; align-items:center; gap:10px;">
                                    <img src="{{ $member->avatar_url ?? 'https://ui-avatars.com/api/?name='.urlencode($member->name).'&color=fff&background=0abf8e&size=32' }}"
                ...
                <table class="gh-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:13px; color:#6b7280;">{{ $att->check_out ? \Carbon\Carbon::parse($att->check_out)->format('h:i A') : '<span style="color:#f97316;">Active</span>' }}</td>
                        </tr>
                        @empty
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const revenueOptions = {
            ...
            yaxis: { labels: { style: { fontSize: '12px', colors: '#9ca3af' }, formatter: v => '₹' + (v >= 1000 ? (v/1000).toFixed(0)+'k' : v) } },
            colors: ['#0abf8e'],
        ...
        new ApexCharts(document.querySelector('#memberStatusChart'), statusOptions).render();
    });
    </script>
    @endpush
</x-layouts.app>
