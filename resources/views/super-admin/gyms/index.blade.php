            ...
            <table style="width:100%;border-collapse:collapse;font-size:13px;">
                <thead>
                    <tr style="background:#f8fafc;border-bottom:1px solid #e2e8f0;">
                        ...
                        <th style="padding:11px 16px;text-align:left;font-size:11px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.05em;">Owner</th>
                ...
                @php
                    ...
                    $planColors = ['basic'=>['#dbeafe','#1d4ed8'],'pro'=>['#d1fae5','#065f46'],'enterprise'=>['#f3e8ff','#7e22ce']];
                    $pc = $planColors[$gym->subscription_plan] ?? ['#f1f5f9','#475569'];
                ...
                <tr style="border-top:1px solid #f1f5f9;">
                    ...
                    <td style="padding:12px 16px;">
                        <span style="padding:3px 10px;border-radius:20px;font-size:12px;font-weight:600;background:{{ $pc[0] }};color:{{ $pc[1] }};">
                            {{ ucfirst($gym->subscription_plan) }}
                        </span>
                    </td>
                    <td style="padding:12px 16px;">
                    ...
                    <td style="padding:12px 16px;">
                        @if($sub)
                        <div style="font-size:13px;font-weight:600;color:#0f172a;">₹{{ number_format($sub->amount) }}/{{ $sub->billing_cycle === 'monthly' ? 'mo' : 'yr' }}</div>
                        ...
                        @else
                        <span style="color:#94a3b8;font-size:13px;">No subscription</span>
                        @endif
                    </td>
