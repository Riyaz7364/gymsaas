...
<aside class="gh-sidebar relative" id="sidebar" x-data="{ open: false }">
    ...
    <a href="{{ gym_route('gym.dashboard') }}" class="gh-sidebar-logo">
    ...
    <nav class="pb-8" id="sidebar-nav">
        ...
        <a href="{{ gym_route('gym.dashboard') }}"
           class="gh-nav-item {{ request()->routeIs('gym.dashboard', 'dashboard') ? 'active' : '' }}">
        ...
        <a href="{{ route('gym.modules.index', auth()->user()->gym) }}"
           class="gh-nav-item {{ request()->routeIs('gym.modules.index') ? 'active' : '' }}">
        ...
        <a href="{{ route('gym.trainers.index', auth()->user()->gym) }}"
           class="gh-nav-item {{ request()->routeIs('gym.trainers.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('gym.members.index', auth()->user()->gym) }}"
           class="gh-nav-item {{ request()->routeIs('gym.members.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('gym.plans.index', auth()->user()->gym) }}"
           class="gh-nav-item {{ request()->routeIs('gym.plans.*') ? 'active' : '' }}">
        ...
        <div x-data="{ open: {{ request()->routeIs('gym.workout-sequences.*', 'gym.workout-activities.*', 'gym.workout-categories.*') ? 'true' : 'false' }} }">
            <a href="#" @click.prevent="open = !open"
               class="gh-nav-item {{ request()->routeIs('gym.workout*') ? 'active' : '' }}">
            ...
            <div x-show="open" x-transition class="gh-nav-submenu">
                <a href="{{ route('gym.workout-sequences.index', auth()->user()->gym) }}"   class="gh-nav-item {{ request()->routeIs('gym.workout-sequences.*') ? 'active' : '' }}">Sequences</a>
                <a href="{{ route('gym.workout-activities.index', auth()->user()->gym) }}"  class="gh-nav-item {{ request()->routeIs('gym.workout-activities.*') ? 'active' : '' }}">Activities</a>
                <a href="{{ route('gym.workout-categories.index', auth()->user()->gym) }}"  class="gh-nav-item {{ request()->routeIs('gym.workout-categories.*') ? 'active' : '' }}">Categories</a>
            </div>
        </div>
        @endmodule

        @module('diet_management')
        <div x-data="{ open: {{ request()->routeIs('gym.diet-plans.*', 'gym.food-items.*', 'gym.food-categories.*') ? 'true' : 'false' }} }">
            <a href="#" @click.prevent="open = !open"
               class="gh-nav-item {{ request()->routeIs('gym.diet-plans.*', 'gym.food-items.*', 'gym.food-categories.*') ? 'active' : '' }}">
            ...
            <div x-show="open" x-transition class="gh-nav-submenu">
                <a href="{{ route('gym.diet-plans.index', auth()->user()->gym) }}?type=default" class="gh-nav-item">Diet Plans</a>
                <a href="{{ route('gym.food-items.index', auth()->user()->gym) }}"  class="gh-nav-item">Food & Drinks</a>
                <a href="{{ route('gym.food-categories.index', auth()->user()->gym) }}"  class="gh-nav-item">Categories</a>
            </div>
        </div>
        @endmodule

        @module('body_progress')
        <div x-data="{ open: {{ request()->routeIs('gym.body-stats.*', 'gym.progress-photos.*', 'body-stats.*', 'progress-photos.*') ? 'true' : 'false' }} }">
            <a href="#" @click.prevent="open = !open"
               class="gh-nav-item {{ request()->routeIs('gym.body-stats.*', 'gym.progress-photos.*', 'body-stats.*', 'progress-photos.*') ? 'active' : '' }}">
            ...
            <div x-show="open" x-transition class="gh-nav-submenu">
                <a href="{{ gym_route('gym.body-stats.index') }}" class="gh-nav-item {{ request()->routeIs('gym.body-stats.*', 'body-stats.*') ? 'active' : '' }}">Body Stats</a>
                <a href="{{ gym_route('gym.progress-photos.index') }}" class="gh-nav-item {{ request()->routeIs('gym.progress-photos.*', 'progress-photos.*') ? 'active' : '' }}">Progress Photos</a>
            </div>
        </div>
        @endmodule

        @module('attendance_management')
        <a href="{{ gym_route('gym.attendance.index') }}"
           class="gh-nav-item {{ request()->routeIs('gym.attendance.*', 'attendance.*') ? 'active' : '' }}">
        ...
        <div x-data="{ open: {{ request()->routeIs('gym.finance*', 'gym.invoices.*', 'gym.expenses.*', 'gym.payments*', 'finance.*', 'invoices.*', 'expenses.*', 'payments.*') ? 'true' : 'false' }} }">
            <a href="#" @click.prevent="open = !open"
               class="gh-nav-item {{ request()->routeIs('gym.finance*', 'gym.invoices.*', 'gym.expenses.*', 'gym.payments*', 'finance.*', 'invoices.*', 'expenses.*', 'payments.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" /></svg>
                Finance
                <svg class="ml-auto transition-transform duration-200" :class="open ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
            </a>
            <div x-show="open" x-transition class="gh-nav-submenu">
                <a href="{{ gym_route('gym.finance') }}"    class="gh-nav-item {{ request()->routeIs('gym.finance*', 'finance.*') ? 'active' : '' }}">Overview</a>
                <a href="{{ gym_route('gym.invoices.index') }}"   class="gh-nav-item {{ request()->routeIs('gym.invoices.*', 'invoices.*') ? 'active' : '' }}">Invoices</a>
                <a href="{{ gym_route('gym.expenses.index') }}"   class="gh-nav-item {{ request()->routeIs('gym.expenses.*', 'expenses.*') ? 'active' : '' }}">Expenses</a>
                @module('online_payments')
                <a href="{{ gym_route('gym.payments') }}"   class="gh-nav-item {{ request()->routeIs('gym.payments*', 'payments.*') ? 'active' : '' }}">Payment History</a>
                @endmodule
            </div>
        </div>
        @endmodule
        ...
        <a href="{{ gym_route('gym.events.index') }}"
           class="gh-nav-item {{ request()->routeIs('gym.events.*', 'events.*') ? 'active' : '' }}">
        ...
        <div x-data="{ open: {{ request()->routeIs('gym.whatsapp.*', 'whatsapp.*') ? 'true' : 'false' }} }">
            <a href="#" @click.prevent="open = !open"
               class="gh-nav-item {{ request()->routeIs('gym.whatsapp.*', 'whatsapp.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" /></svg>
                WhatsApp
                <svg class="ml-auto transition-transform duration-200" :class="open ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
            </a>
            <div x-show="open" x-transition class="gh-nav-submenu">
                <a href="{{ gym_route('gym.whatsapp.campaigns.index') }}" class="gh-nav-item {{ request()->routeIs('gym.whatsapp.campaigns.*', 'whatsapp.campaigns.*') ? 'active' : '' }}">Campaigns</a>
                <a href="{{ gym_route('gym.whatsapp.logs') }}"           class="gh-nav-item {{ request()->routeIs('gym.whatsapp.logs', 'whatsapp.logs') ? 'active' : '' }}">Logs</a>
            </div>
        </div>
        @endmodule

        @module('advanced_reports')
        <div x-data="{ open: {{ request()->routeIs('gym.reports.*', 'reports.*') ? 'true' : 'false' }} }">
            <a href="#" @click.prevent="open = !open"
               class="gh-nav-item {{ request()->routeIs('gym.reports.*', 'reports.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg>
                Reports
                <svg class="ml-auto transition-transform duration-200" :class="open ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
            </a>
            <div x-show="open" x-transition class="gh-nav-submenu">
                <a href="{{ gym_route('gym.reports.members') }}"  class="gh-nav-item">Members</a>
                <a href="{{ gym_route('gym.reports.revenue') }}"  class="gh-nav-item">Revenue</a>
                <a href="{{ gym_route('gym.reports.trainers') }}" class="gh-nav-item">Trainers</a>
            </div>
        </div>
        @endmodule

        @module('ai_track_user')
        <a href="{{ gym_route('gym.ai-track-user.index') }}"
           class="gh-nav-item {{ request()->routeIs('ai-track-user.*', 'gym.ai-track-user.*') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904 9 18.75l-1.5-1.5-2.846.813.813-2.846-1.5-1.5L6.813 13l.813-2.846 1.5 1.5 2.846-.813-.813 2.846 1.5 1.5L9.813 15.904zm8.759-8.938a3.75 3.75 0 1 1-5.304 5.304 3.75 3.75 0 0 1 5.304-5.304zM12 21a8.25 8.25 0 1 1 8.25-8.25" /></svg>
            AI Track User
        </a>
        @endmodule

        @module('notice_board')
        <a href="{{ gym_route('gym.notices.index') }}"
           class="gh-nav-item {{ request()->routeIs('gym.notices.*', 'notices.*') ? 'active' : '' }}">
        ...
        <a href="{{ gym_route('gym.contact-diary.index') }}"
           class="gh-nav-item {{ request()->routeIs('gym.contact-diary.*', 'contact-diary.*') ? 'active' : '' }}">
        ...
        <a href="{{ gym_route('gym.settings.index') }}"
           class="gh-nav-item {{ request()->routeIs('gym.settings.*', 'settings.*') ? 'active' : '' }}">
...
<header class="gh-topbar">
    ...
    <div class="flex items-center gap-3">
        ...
        {{-- Settings quick link --}}
        <a href="{{ gym_route('gym.settings.index') }}" class="p-2 rounded-lg hover:bg-gray-100 text-gray-500">
        ...
        <div x-data="{ userOpen: false }" class="relative">
            ...
            <div x-show="userOpen" @click.outside="userOpen = false" x-transition
                ...
                <a href="{{ gym_route('gym.settings.index') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm hover:bg-gray-50">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var storageKey = 'gh_sidebar_scroll_top';
    ...
    var saveScroll = function () {
        window.localStorage.setItem(storageKey, String(sidebar.scrollTop));
    };
