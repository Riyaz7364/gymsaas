...
<aside class="gh-sidebar relative" id="sidebar" x-data="{ open: false }">
    ...
    <nav class="pb-8">
        ...
        <div x-data="{ open: {{ request()->routeIs('body-stats.*', 'progress-photos.*') ? 'true' : 'false' }} }">
            ...
            <div x-show="open" x-transition class="gh-nav-submenu">
                <a href="{{ gym_route('gym.body-stats.index') }}" class="gh-nav-item {{ request()->routeIs('body-stats.*') ? 'active' : '' }}">Body Stats</a>
                <a href="{{ gym_route('gym.progress-photos.index') }}" class="gh-nav-item {{ request()->routeIs('progress-photos.*') ? 'active' : '' }}">Progress Photos</a>
            </div>
        </div>
        @endmodule
        ...
        <div x-data="{ open: {{ request()->routeIs('finance.*', 'invoices.*', 'expenses.*', 'payments.*') ? 'true' : 'false' }} }">
            <a href="#" @click.prevent="open = !open"
               class="gh-nav-item {{ request()->routeIs('finance.*', 'invoices.*', 'expenses.*', 'payments.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" /></svg>
                Finance
                <svg class="ml-auto transition-transform duration-200" :class="open ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
            </a>
            <div x-show="open" x-transition class="gh-nav-submenu">
                <a href="{{ gym_route('gym.finance') }}"    class="gh-nav-item {{ request()->routeIs('finance.*') ? 'active' : '' }}">Overview</a>
                <a href="{{ gym_route('gym.invoices.index') }}"   class="gh-nav-item {{ request()->routeIs('invoices.*') ? 'active' : '' }}">Invoices</a>
                <a href="{{ gym_route('gym.expenses.index') }}"   class="gh-nav-item {{ request()->routeIs('expenses.*') ? 'active' : '' }}">Expenses</a>
                @module('online_payments')
                <a href="{{ gym_route('gym.payments') }}"   class="gh-nav-item {{ request()->routeIs('payments.*') ? 'active' : '' }}">Payment History</a>
                @endmodule
            </div>
        </div>
        @endmodule
        ...
        <div x-data="{ open: {{ request()->routeIs('whatsapp.*') ? 'true' : 'false' }} }">
            ...
            <div x-show="open" x-transition class="gh-nav-submenu">
                <a href="{{ gym_route('gym.whatsapp.campaigns.index') }}" class="gh-nav-item {{ request()->routeIs('whatsapp.campaigns.*') ? 'active' : '' }}">Campaigns</a>
                <a href="{{ gym_route('gym.whatsapp.logs') }}"           class="gh-nav-item {{ request()->routeIs('whatsapp.logs') ? 'active' : '' }}">Logs</a>
            </div>
        </div>
        @endmodule
