<x-layouts.app>
    <x-slot:title>New Workout Plan — {{ config('app.name') }}</x-slot:title>
    <x-slot:header>New Workout Plan</x-slot:header>
    <x-slot:topbarTitle>New Workout Plan</x-slot:topbarTitle>
    <x-slot:breadcrumb>Home / <a href="{{ route('workout-plans.index') }}">Workout Plans</a> / New</x-slot:breadcrumb>
        ...
        <div class="gh-card-body">
            ...
            <form method="POST" action="{{ route('workout-plans.store') }}">
                ...
                <div style="margin-top:20px;display:flex;gap:10px;">
                    ...
                    <a href="{{ route('workout-plans.index') }}" class="gh-btn gh-btn-outline">Cancel</a>
                </div>
            </form>
        </div>
    </div>
