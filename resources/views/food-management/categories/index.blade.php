<x-layouts.app>
    ...
    <x-slot:breadcrumb>Home / <a href="{{ gym_route('gym.food-categories.index') }}" style="color:var(--gh-primary);text-decoration:none;">Categories</a></x-slot:breadcrumb>
    ...
    <div class="gh-card">
        <div class="gh-card-header">
            ...
            <a href="{{ gym_route('gym.food-categories.create') }}" class="gh-btn gh-btn-primary">+ New Category</a>
        </div>
        ...
        <div class="gh-card-body" style="padding:0;">
            <table class="gh-table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ gym_route('gym.food-categories.edit', [$gym, $category]) }}" class="gh-btn gh-btn-outline gh-btn-sm">Edit</a>
                        <form method="POST" action="{{ gym_route('gym.food-categories.destroy', [$gym, $category]) }}" style="display:inline;" onsubmit="return confirm('Delete this category? Associated food items will not be deleted.');">
                            @csrf @method('DELETE')
