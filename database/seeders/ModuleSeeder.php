...
class ModuleSeeder extends Seeder
{
    public function run(): void
    {
        $modules = [
            ...
            ['key' => 'ai_track_user', 'label' => 'AI Track User', 'description' => 'Predict churn risk, suggest offer timing, and explain why members may leave', 'group_name' => 'AI & Automation', 'sort_order' => 23, 'price' => null, 'billing_type' => null, 'icon' => 'ai-track'],
            ['key' => 'whatsapp_updates', 'label' => 'WhatsApp Notifications', 'description' => 'Automated WhatsApp messages for renewals and updates', 'group_name' => 'Notifications', 'sort_order' => 24, 'price' => null, 'billing_type' => null, 'icon' => 'whatsapp'],
            ['key' => 'sms_notifications', 'label' => 'SMS Notifications', 'description' => 'SMS alerts for payments, renewals, and events', 'group_name' => 'Notifications', 'sort_order' => 25, 'price' => null, 'billing_type' => null, 'icon' => 'sms'],
            ['key' => 'email_marketing', 'label' => 'Email Marketing', 'description' => 'Send newsletters and promotions to members', 'group_name' => 'Notifications', 'sort_order' => 26, 'price' => null, 'billing_type' => null, 'icon' => 'email'],
